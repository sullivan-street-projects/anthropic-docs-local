...
| `SubagentStart`, `SubagentStop`                                                                                                                                 | Agent type                   | `general-purpose`, `Bash`, `Explore`, `Plan`, or custom agent names                                                                                                                                           |
...
| `scratchpad_dir`  | Path to the session's scratchpad directory for temporary files (v2.1.257+)                        |
