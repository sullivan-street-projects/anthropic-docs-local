...
| Repository | Stars | Description |
|------------|-------|-------------|
| hh-rlhf | 1,810 | RLHF human preference data |
| evals | 319 | Evaluation resources |
| ConstitutionalHarmlessnessPaper | 249 | Constitutional AI research |
| toy-models-of-superposition | 132 | Superposition paper notebooks |
| sleeper-agents-paper | 123 | Sleeper agents research |
| political-neutrality-eval | 108 | Political neutrality evaluation |

## Tools & Utilities

| Repository | Stars | Description |
|------------|-------|-------------|
| claude-plugins-official | 1,518 | Official Claude Code plugins |
| anthropic-tools | 337 | Tools and utilities |
| PySvelte | 201 | Python-Svelte bridge |
| devcontainer-features | 188 | Dev container features |
| anthropic-retrieval-demo | 177 | Search and retrieval demo |
| life-sciences | 106 | Life sciences MCP servers |
| anthropic-tokenizer-typescript | 88 | TypeScript tokenizer |
