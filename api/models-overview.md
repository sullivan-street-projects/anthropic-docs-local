...
> **Note:** Claude Opus 4.1 (`claude-opus-4-1-20250805`) was retired on August 5, 2026. Migrate to Claude Opus 5.
...
- **Adaptive thinking:** Opus 5, Opus 4.8, Opus 4.7, Opus 4.6, Sonnet 5, and Sonnet 4.6 support dynamic thinking allocation; Fable 5 and Mythos 5 have always-on adaptive thinking. On Opus 5, thinking is on by default; disabling is allowed only at effort `high` or below
