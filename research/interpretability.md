...
Research revealing an emergent "mental workspace" in Claude -- an internal computational space that holds thoughts and intermediate representations that don't appear in the model's output. This discovery provides new insights into how language models organize and process information internally, with implications for interpretability and understanding model cognition.
