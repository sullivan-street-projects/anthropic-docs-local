...
**Threat model:**
- Malicious web content targeting AI agents
- Instruction injection via scraped data
...
### Elections-Related Risk Testing (Jun 6, 2024)
Systematic evaluation of AI in electoral contexts.

**Tested scenarios:**
- Voter information queries
- Candidate information accuracy
- Misinformation resistance
- Persuasion attempts

**Safeguards developed:**
- Enhanced fact-checking for electoral topics
- Balanced presentation requirements
- Refusal of clearly manipulative requests

## Governance Frameworks

### Evaluating AI Systems (Oct 4, 2023)
Framework for responsible AI evaluation.
...
**Principles:**
- Third-party evaluation where possible
- Transparency about limitations
- Iterative improvement

### Collective Constitutional AI (Oct 17, 2023)
Experiment in public input on AI values.

**Process:**
- Public solicitation of principles
- Aggregation and synthesis
- Integration into training
- Evaluation of outcomes

**Findings:**
- Diverse input improves coverage
...
- Archive access for research
- Security update continuation

### Claude's Character (Jun 8, 2024)
Intentional character training for beneficial traits.
...
Anthropic's policy research often involves:
