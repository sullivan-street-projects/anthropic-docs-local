...
| Category                                | Focus Area                         | Key Papers                                                         |
| --------------------------------------- | ---------------------------------- | ------------------------------------------------------------------ |
| [Alignment](alignment.md)               | Safety, RLHF, Constitutional AI    | Constitutional Classifiers, Sleeper Agents, Teaching Claude Why    |
| [Interpretability](interpretability.md) | Mechanistic understanding          | Transformer Circuits, Superposition, Natural Language Autoencoders |
| [Societal Impacts](societal-impacts.md) | Economics, work transformation     | AI Productivity Gains, Clio, What 81,000 People Want from AI       |
| [Policy](policy.md)                     | Governance, responsible deployment | Project Vend, Project Deal, Elections Testing                      |
...
| Dec 4, 2025  | Anthropic Interviewer (1,250 professionals)       | Societal Impacts  |
| Dec 2, 2025  | How AI is Transforming Work at Anthropic          | Societal Impacts  |
| Nov 25, 2025 | Estimating AI Productivity Gains                  | Economic Research |
| Nov 24, 2025 | Mitigating Prompt Injection Risks                 | Product           |
| Nov 21, 2025 | Emergent Misalignment from Reward Hacking         | Alignment         |
...
These foundational papers define Anthropic's research directions:

### Constitutional AI (Dec 2022)

Introduced harmlessness from AI feedback, establishing the constitutional approach to alignment that underpins Claude's training.

### Sleeper Agents (Jan 2024)

Demonstrated that deceptive behaviors can persist through safety training, highlighting challenges in AI safety.

### Transformer Circuits Framework (Dec 2021)

Established the mechanistic interpretability approach for understanding neural network internals.

### Toy Models of Superposition (Sep 2022)

Revealed how neural networks pack more concepts than dimensions, explaining polysemanticity.

### RLHF Training (Apr 2022)

Foundational work on training helpful and harmless assistants using reinforcement learning from human feedback.
...
- Deceptive alignment (sleeper agents, alignment faking)
- Sycophancy and faithfulness
- Teaching Claude why (reducing agentic misalignment)

### Mechanistic Interpretability

- Transformer circuits and features
- Superposition and monosemanticity
- Dictionary learning and natural language autoencoders
- Induction heads and in-context learning

### Real-World Impact

- Productivity measurement and economic indices
- Work transformation studies (including agentic coding)
- Bias and discrimination analysis
- Global opinion representation (81,000 person study)
- AI agents in science (biology, chemistry)

### Responsible Deployment

- Red teaming methodologies (Frontier Red Team)
- Evaluation frameworks
- Elections and sensitive use cases
- Model deprecation policies
- Real-world agent experiments (Project Vend, Project Deal, Project Fetch)

## External Resources

- [Research Page](https://www.anthropic.com/research)
- [Transformer Circuits Thread](https://transformer-circuits.pub/)
- [GitHub: anthropics/evals](https://github.com/anthropics/evals)
